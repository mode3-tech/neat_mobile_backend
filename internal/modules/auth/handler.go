...
func (h *Handler) ForgotTransactionPin(c *gin.Context) {
	...
	resp, err := h.service.ForgotTransactionPin(c.Request.Context(), mobileUserID)
	if err != nil {
		mapped := response.MapError(err)
		c.AbortWithStatusJSON(mapped.Status, response.APIResponse[any]{
			Status: "error",
...
func (h *Handler) VerifyForgotTransactionPinOTP(c *gin.Context) {
	...
	resp, err := h.service.VerifyForgotTransactionPinOTP(c.Request.Context(), mobileUserID, req)
	if err != nil {
		mapped := response.MapError(err)
		c.AbortWithStatusJSON(mapped.Status, response.APIResponse[any]{
			Status: "error",
...
func (h *Handler) ResendForgotTransactionPinOTP(c *gin.Context) {
	...
	if err := h.service.ResendForgotTransactionPinOTP(c.Request.Context(), mobileUserID); err != nil {
		mapped := response.MapError(err)
		c.AbortWithStatusJSON(mapped.Status, response.APIResponse[any]{
			Status: "error",
			Error:  &mapped.Error,
...
func (h *Handler) ResetTransactionPin(c *gin.Context) {
	...
	if err := h.service.ResetTransactionPin(c.Request.Context(), mobileUserID, req); err != nil {
		mapped := response.MapError(err)
		c.AbortWithStatusJSON(mapped.Status, response.APIResponse[any]{
			Status: "error",
			Error:  &mapped.Error,
...
func (h *Handler) RequestPasswordChange(c *gin.Context) {
	...
	resp, err := h.service.RequestPasswordChange(c.Request.Context(), mobileUserID)
	if err != nil {
		mapped := response.MapError(err)
		c.AbortWithStatusJSON(mapped.Status, response.APIResponse[any]{
			Status: "error",
...
func (h *Handler) ResendPasswordChangeOTP(c *gin.Context) {
	...
	resp, err := h.service.ResendPasswordChangeOTP(c.Request.Context(), mobileUserID)
	if err != nil {
		mapped := response.MapError(err)
		c.AbortWithStatusJSON(mapped.Status, response.APIResponse[any]{
			Status: "error",
...
func (h *Handler) VerifyPasswordChangeOTP(c *gin.Context) {
	...
	resp, err := h.service.VerifyPasswordChangeOTP(c.Request.Context(), mobileUserID, req)
	if err != nil {
		mapped := response.MapError(err)
		c.AbortWithStatusJSON(mapped.Status, response.APIResponse[any]{
			Status: "error",
...
func (h *Handler) ChangePassword(c *gin.Context) {
	...
	if err := h.service.ChangePassword(c.Request.Context(), mobileUserID, req); err != nil {
		mapped := response.MapError(err)
		c.AbortWithStatusJSON(mapped.Status, response.APIResponse[any]{
			Status: "error",
			Error:  &mapped.Error,
...
func (h *Handler) RequestTransactionPinChange(c *gin.Context) {
	...
	resp, err := h.service.RequestTransactionPinChange(c.Request.Context(), mobileUserID)
	if err != nil {
		mapped := response.MapError(err)
		c.AbortWithStatusJSON(mapped.Status, response.APIResponse[any]{
			Status: "error",
...
func (h *Handler) ResendRequestTransactionPinChangeOTP(c *gin.Context) {
	...
	resp, err := h.service.ResendTransactionPinChangeOTP(c.Request.Context(), mobileUserID)
	if err != nil {
		mapped := response.MapError(err)
		c.AbortWithStatusJSON(mapped.Status, response.APIResponse[any]{
			Status: "error",
...
func (h *Handler) VerifyTransactionPinChangeOTP(c *gin.Context) {
	...
	resp, err := h.service.VerifyTransactionPinChangeOTP(c.Request.Context(), mobileUserID, req)
	if err != nil {
		mapped := response.MapError(err)
		c.AbortWithStatusJSON(mapped.Status, response.APIResponse[any]{
			Status: "error",
...
func (h *Handler) ChangeTransactionPin(c *gin.Context) {
	...
	if err := h.service.ChangeTransactionPin(c.Request.Context(), mobileUserID, req); err != nil {
		mapped := response.MapError(err)
		c.AbortWithStatusJSON(mapped.Status, response.APIResponse[any]{
			Status: "error",
			Error:  &mapped.Error,
...
func (h *Handler) ToggleBiometrics(c *gin.Context) {
	...
	resp, err := h.service.ToggleBiometrics(c.Request.Context(), mobileUserID)
	if err != nil {
		mapped := response.MapError(err)
		c.AbortWithStatusJSON(mapped.Status, response.APIResponse[any]{
			Status: "error",
...
func (h *Handler) VerifyNINWithFace(c *gin.Context) {
	var req NINWithFaceValidationRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.AbortWithStatusJSON(http.StatusBadRequest, response.APIResponse[any]{
			Status: "error",
			Error: &response.APIError{
	...
	info, err := h.service.ValidateNINWithFace(c.Request.Context(), req)
	if err != nil {
		mapped := response.MapError(err)
		c.AbortWithStatusJSON(mapped.Status, response.APIResponse[any]{
			Status: "error",
	...
	c.JSON(http.StatusOK, response.APIResponse[NINWithFaceValidationResponse]{
		Status:  "success",
		Message: "NIN with face verification was successful.",
		Data: &NINWithFaceValidationResponse{
			NINWithFaceVerificationID: info.faceCheckID,
		},
	})
}

func (h *Handler) VerifyBVNWithFace(c *gin.Context) {
	var req BVNWithFaceValidationRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.AbortWithStatusJSON(http.StatusBadRequest, response.APIResponse[any]{
			Status: "error",
			Error: &response.APIError{
	...
	info, err := h.service.ValidateBVNWithFace(c.Request.Context(), req)
	if err != nil {
		mapped := response.MapError(err)
		c.AbortWithStatusJSON(mapped.Status, response.APIResponse[any]{
			Status: "error",
	...
	c.JSON(http.StatusOK, response.APIResponse[BVNWithFaceValidationResponse]{
		Status:  "success",
		Message: "BVN with face verification was successful.",
		Data: &BVNWithFaceValidationResponse{
			BVNWithFaceVerificationID: info.faceCheckID,
		},
	})
}
